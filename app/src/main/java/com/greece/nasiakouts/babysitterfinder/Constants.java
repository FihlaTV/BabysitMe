...
public class Constants {
    ...
    public static final int INDEX_PHONE_INPUT = 2;
    public static final int INDEX_PASSWORD_INPUT = 3;
    public static final int INDEX_CONFIRM_PASSWORD_INPUT = 4;
    public static final int INDEX_DATE_BORN_INPUT = 5;

    // Registration Common Activity - Radios Indices
    public static final int INDEX_RADIO_BABYSITTER = 0;
